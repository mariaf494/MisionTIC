...
def filtros_habilidades(datos, col_preguntas, grafica):
    ...
    lista_grupos = datos.Grupo.unique()
    grupo = st.multiselect("Seleccione el grupo: ",  lista_grupos)
    #lista_instrumento = list(datos.iloc[:, 1:col_preguntas].columns)
...
def pag_encuestas(col_preguntas, columna_unica, file):
    ...
    if file:
        ...
        orden_semana = ["C1-S1", "C1-S2",
                        "C1-S3", "C1-S4", "C1-S5", "C1-S6", "C1-S7", "C1-S8", "C2-S1", "C2-S2", "C2-S3", "C2-S4", "C2-S5", "C2-S6" , "C2-S7" , "C3-S1" , "C3-S2" , "C3-S3" , "C3-S4" , "C3-S5" ,"C3-S6" , "C3-S7" , "C3-S8"]
